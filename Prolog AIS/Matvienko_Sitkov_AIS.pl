...
customer('000000000',full_name('Petrenko','Roman','Stepanovych'),address('Ukraine','Kharkiv','Izum','Zelena st.',5),contacts("(0-444) 219-140", "petrenko@gmail.com")).
customer('000000001',full_name('Vasylenko','Andriy','Vasyliovych'),address('Ukraine','Chernihiv','Pryluky','Vesela st.',12),contacts("(0-800) 515-130", "vasylenko@gmail.com")).
customer('000000002',full_name('Sedash','Nina','Yuriivna'),address('Ukraine','Donetsk','Bakhmut','Pivdenna st.',23),contacts("(0-999) 233-140", "sedash@gmail.com")).
customer('000000003',full_name('Trubeko','Tetyana','Vasylivna'),address('Ukraine','Vinnytsia','Tulchyn','Chervona st.',54),contacts("(0-532) 253-166", "trubeko@gmail.com")).
customer('000000004',full_name('Chaplyk','Dmytro','Vasyliovych'),address('Ukraine','Vinnytsia','Zhmerynka','Horbatova st.',45),contacts("(0-342) 245-155", "chaplyk@gmail.com")).
customer('000000005',full_name('Volkov','Valentyn','Romanovych'),address('Ukraine','Odesa','Izmail','Vyshneva st.',9),contacts("(0-800) 200-990", "volkov@gmail.com")).
customer('000000006',full_name('Vaha','Ludmila','Oleksiivna'),address('Ukraine','Zaporizhzhia','Zaporizhzhia','Chorna st.',65),contacts("(0-550) 212-174", "vaha@gmail.com")).
customer('000000007',full_name('Zayarniy','Oleksandr','Hryhorovych'),address('Ukraine','Kyiv','Brovary','Holodna st.',43),contacts("(0-234) 918-435", "zayarniy@gmail.com")).
customer('000000008',full_name('Andrushchenko','Stepan','Maksymovych'),address('Ukraine','Donetsk','Kramatorsk','Sumna st.',85),contacts("(0-800) 492-904", "andrushchenko@gmail.com")).
customer('000000009',full_name('Salnikov','Myhaylo','Serhiyovych'),address('Ukraine','Lviv','Lviv','Nova st.',30),contacts("(0-844) 950-346", "salnikov@gmail.com")).
customer('000000010',full_name('Titov','Roman','Dmytrovych'),address('Ukraine','Lviv','Holodna Voda','Tepla st.',71),contacts("(0-444) 356-776", "titov@gmail.com")).
customer('000000011',full_name('Lagutkova','Elizavetta','Serhiivna'),address('Ukraine','Dnipro','Kryviy Rih','Dovha st.',3),contacts("(0-444) 668-434", "lagutkova@gmail.com")).
customer('000000012',full_name('Grinev','Pavlo','Oleksandrovych'),address('Ukraine','Kyiv','Kyiv','Soniachna st.',84),contacts("(0-800) 666-555", "grinev@gmail.com")).
customer('000000013',full_name('Zozulia','Ivan','Ivanovych'),address('Ukraine','Mykolaiv','Mykolaiv','Poetychna st.',49),contacts("(0-800) 553-434", "zozulia@gmail.com")).
customer('000000014',full_name('Hryhorenko','David','Romanovych'),address('Ukraine','Donetsk','Slovyansk','Chysta st.',76),contacts("(0-777) 666-434", "hryhorenko@gmail.com")).
...
customers_all_not_those(CustomerCode,GoodCustomerCode):-
    customer(GoodCustomerCode,_,_,_),
    is_customer_code(CustomerCode),
...
% Визначення операторів для запиту 3
